...
import type { AddToWaitingListRequest, AddToWaitingListResponse, WaitingListResponse } from "../models/index";
import {
...
export class WaitingListApi extends runtime.BaseAPI {
  /**
   */
  async apiWaitingListAddPartyToWaitinglistPostRaw(
    requestParameters: ApiWaitingListAddPartyToWaitinglistPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<AddToWaitingListResponse>> {
  ...
  /**
   */
  async apiWaitingListAddPartyToWaitinglistPost(
    requestParameters: ApiWaitingListAddPartyToWaitinglistPostRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<AddToWaitingListResponse> {
  ...
  /**
   */
  async apiWaitingListWaitingListGetRaw(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
  ): Promise<runtime.ApiResponse<WaitingListResponse>> {
    const queryParameters: any = {};
  ...
  /**
   */
  async apiWaitingListWaitingListGet(
    initOverrides?: RequestInit | runtime.InitOverrideFunction,
